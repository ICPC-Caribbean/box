...
\inputdesc{The first line of the input  contains five integers $A_1$, $B_1$, $C_1$,
...
\outputdesc{For each query in the input output a line containing the uppercase letter \literalchar{Y}
